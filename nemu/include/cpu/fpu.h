...
void fpu_load_idx(uint32_t idx);
uint32_t fpu_store();
uint32_t fpu_peek();
void fpu_add(uint32_t val);
void fpu_add_idx(uint32_t idx, uint32_t store_idx);
void fpu_sub(uint32_t val);
void fpu_sub_idx(uint32_t idx, uint32_t store_idx);
void fpu_subr(uint32_t val);
void fpu_subr_idx(uint32_t idx, uint32_t store_idx);
void fpu_mul(uint32_t val);
void fpu_mul_idx(uint32_t idx, uint32_t store_idx);
void fpu_div(uint32_t val);
void fpu_div_idx(uint32_t idx, uint32_t store_idx);
void fpu_divr(uint32_t val);
void fpu_divr_idx(uint32_t idx, uint32_t store_idx);
void fpu_xch(uint32_t idx);
void fpu_copy(uint32_t idx);
void fpu_cmp(uint32_t idx);
void fpu_cmpi(uint32_t idx);
void fpu_cmp_mem(uint32_t val);
void fpu_chs();
void fpu_abs();
